...
Plugin URI: http://www.madebyguerrilla.com
Description: Shortcodes and widgets for the Clarity WordPress theme from Made by Guerrilla.
Version: 1.4
Author: Mike Smith
...
function clarity_recent_posts_shortcode($atts){
	...
	while($q->have_posts()) : $q->the_post();
		...
		$list .= '<div class="'. $class .' recentposts"><img src="' . $thumb_url .'" alt="" /><h3><a href="' . get_permalink() . '">' . get_the_title() . '</a></h3>'. excerpt(30) .'</div>';
	endwhile;
wp_reset_query();
return $list . '';
}
...
// From The Blog shortcode

function clarity_fromtheblog_shortcode($atts){
	...
	$list = '<div class="contentwrap">';

	while($q->have_posts()) : $q->the_post();
		$thumb_id = get_post_thumbnail_id();
		$thumb_url_array = wp_get_attachment_image_src($thumb_id, $imgsize, true);
		$thumb_url = $thumb_url_array[0];
		$list .= '<div class="fromtheblog '. $class .'" style="background: url(' . $thumb_url .') no-repeat center center; background-size: cover;"><div><h3><a href="' . get_permalink() . '">' . get_the_title() . '<span>'. get_the_excerpt() .'</span></a></h3></div></div>';
	endwhile;
wp_reset_query();
return $list . '</div>';
}

add_shortcode('fromtheblog', 'clarity_fromtheblog_shortcode');
...
function clarity_auto_excerpt_more( $more ) {
	return '' . clarity_continue_reading_link();
}
...
function clarityinfobox($atts, $content = null) {
	...
	$atts));
	return '<div class="infobox '. $class .' '. $text .'"><a href="' . $href . '"><img src="' . $image .'" alt="' . $title . '" /><h3>' . $title . '<span>' . $subtitle . '</span></h3></a></div>';
}
...
<a href="<?php echo($ClaritySocialTwitter); ?>" title="Twitter" aria-label="Twitter"><i class="fa fa-twitter fa-2x"></i> <span>Twitter</span></a>  
<?php } ?>

<?php if ( $ClaritySocialFacebook !='' ) { ?>
<a href="<?php echo($ClaritySocialFacebook); ?>" title="Facebook" aria-label="Facebook"><i class="fa fa-facebook fa-2x"></i> <span>Facebook</span></a>  
<?php } ?>

<?php if ( $ClaritySocialLinkedin !='' ) { ?>
<a href="<?php echo($ClaritySocialLinkedin); ?>" title="Linkedin" aria-label="LinkedIn"><i class="fa fa-linkedin fa-2x"></i> <span>Linkedin</span></a>  
<?php } ?>

<?php if ( $ClaritySocialGoogle !='' ) { ?>
<a href="<?php echo($ClaritySocialGoogle); ?>" title="Google+" aria-label="Google+"><i class="fa fa-google fa-2x"></i> <span>Google</span></a>  
<?php } ?>

<?php if ( $ClaritySocialInstagram !='' ) { ?>
<a href="<?php echo($ClaritySocialInstagram); ?>" title="Instagram" aria-label="Instagram"><i class="fa fa-instagram fa-2x"></i> <span>Instagram</span></a>  
<?php } ?>

<?php if ( $ClaritySocialPinterest !='' ) { ?>
<a href="<?php echo($ClaritySocialPinterest); ?>" title="Pinterest" aria-label="Pinterest"><i class="fa fa-pinterest fa-2x"></i> <span>Pinterest</span></a>  
<?php } ?>

<?php if ( $ClaritySocialYoutube !='' ) { ?>
<a href="<?php echo($ClaritySocialYoutube); ?>" title="Youtube" aria-label="YouTube"><i class="fa fa-youtube fa-2x"></i> <span>Youtube</span></a>  
<?php } ?>

<?php if ( $ClaritySocialTumblr !='' ) { ?>
<a href="<?php echo($ClaritySocialTumblr); ?>" title="Tumblr" aria-label="Tumblr"><i class="fa fa-tumblr fa-2x"></i> <span>Tumblr</span></a>  
<?php } ?>

<?php if ( $ClaritySocialEmail !='' ) { ?>
<a href="mailto:<?php echo($ClaritySocialEmail); ?>" title="Email" aria-label="Email"><i class="fa fa-envelope fa-2x"></i> <span>Email</span></a>  
<?php } ?>
